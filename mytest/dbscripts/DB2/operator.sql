...
(
   OPERATOR_ID          NUMERIC(18)            not null,
   USER_ID              VARCHAR(20),
   ...
   MEMO                 VARCHAR(512),
   ORG_ID				NUMERIC(18),
   constraint PK_O_USER primary key (OPERATOR_ID)
);

insert into O_OPERATOR (OPERATOR_ID, USER_NAME, USER_ID, BIRTHDAY, GENDER, PHONE, ADDRESS, POSTCODE) values(1000021,'zhangdanfeng','230702195701250544','1957-01-25','M','88080001','no1,zhongguancun street,haidian of peking', '100000');
...
insert into O_OPERATOR (OPERATOR_ID, USER_NAME, USER_ID, BIRTHDAY, GENDER, PHONE, ADDRESS, POSTCODE) values(1000027,'liyanan','230103196612241927','1966-12-24','M','88080007','7 building tuanjinrong hing tech park,huoju country,national high tech area of changsha', '410000');
